...
public class SwaggerConfigure {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.aichu.app.api"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("爱触项目组移动APP-API接口文档")
                .description("Spring Boot中使用Swagger2构建RESTful---API----APP")
