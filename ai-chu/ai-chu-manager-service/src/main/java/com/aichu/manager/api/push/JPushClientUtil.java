package com.aichu.manager.api.push;
...
import com.aichu.manager.config.JPushConfig;
...
//    private static String APP_KEY = "fa3e910098872cb14bde09b6";
//
//    private static String MASTER_SECRET = "083fb0809acd7ef1a00f504f";
    ...
    @PostConstruct
    public void init() {
        APP_KEY = jPushConfig.getAppKey();
        MASTER_SECRET = jPushConfig.getAppSecret();
    }
...
//    }
    ...
    /***
     * @Author Melon
     * @Description 推送给设备标识参数的用户
     * @Date 14:09 2020/1/13
     * @Param [alias--设备标识, notification_title--通知内容标题, msg_title--消息内容标题, msg_content--消息内容, extrasparam--扩展字段（通常传跳转的链接）]
     * @Return int--0推送失败，1推送成功
     **/
    ...
    /***
     * @Author Melon
     * @Description 推送给设备标识参数的用户（定时）
     * @Date 14:10 2020/1/13
     * @Param [alias--设备标识, notification_title--通知内容标题, msg_title--消息内容标题, msg_content--消息内容, extrasparam--扩展字段, time--格式:yyyy-MM-dd HH:mm:ss]
     * @Return int--0推送失败，1推送成功
     **/
    ...
    /***
     * @Author Melon
     * @Description 发送给所有安卓用户
     * @Date 14:11 2020/1/13
     * @Param [notification_title--通知内容标题, msg_title--消息内容标题, msg_content--消息内容, extrasparam--扩展字段]
     * @Return int-0推送失败，1推送成功
     **/
    ...
    /***
     * @Author Melon
     * @Description 发送给所有IOS用户
     * @Date 14:12 2020/1/13
     * @Param [notification_title--通知内容标题, msg_title--消息内容标题, msg_content--消息内容, extrasparam--扩展字段]
     * @Return int--0推送失败，1推送成功
     **/
    ...
    /***
     * @Author Melon
     * @Description 发送给所有用户(定时推送)
     * @Date 14:13 2020/1/13
     * @Param [notification_title--通知内容标题, msg_title--消息内容标题, msg_content--消息内容, extrasparam--扩展字段, time--格式:yyyy-MM-dd HH:mm:ss]
     * @Return int--0推送失败，1推送成功
     **/
...
//    	sendToAllIos("测试", "测试信息", "测试信息", "https://www.baidu.com");
    	sendToAll("测试后台", "测试后台", "测试信息", "https://www.baidu.com");
	}
}
